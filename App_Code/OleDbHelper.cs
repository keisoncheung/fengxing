...
namespace DLL
{
    public class OleDbHelper
    {
       ...
       // public static string Conn { get { return "Provider = Microsoft.Jet.OLEDB.4.0; Data Source = " + HttpContext.Current.Server.MapPath(ConfigurationSettings.AppSettings["AccessConnectionString"]); } }
        ...
        public static string Conn { get { return "Provider=Microsoft.ACE.OLEDB.12.0; Data Source = " + HttpContext.Current.Server.MapPath(ConfigurationSettings.AppSettings["AccessConnectionString"]); } }

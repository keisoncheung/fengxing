<%@ Page Title="" Language="C#" MasterPageFile="~/mar1.master" AutoEventWireup="true"
    CodeFile="aozhou_show.aspx.cs" Inherits="aozhou_show" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <link type="text/css" rel="stylesheet" href="css/aozhou.css" />
    <script type="text/javascript" src="js/azshow.js"></script>
    <script src="js/json2.js" type="text/javascript"></script>
    <script src="js/jsDateFormat.js" type="text/javascript"></script>
    <script type="text/javascript">
       ...
       // var var_date=myDate.getFullYear()+"-"+myDate.getMonth()+"-"+
       var time1 = new Date().Format("M/dd/yyyy");
        ...
        var timecha=Date_Duibi(time1,$("#calOneResult").val());
        if(timecha==false)
        {return;
        }
        ...
        var godate=$("#calOneResult").val();
            var str_child1 = '{"ProId":"' + <%=pro_id %> + '","GoDate":"'+godate+'","CarChilds":[';
            var str_child2 = "";
            for (var i = 1; i < 5; i++) {
                var _child = '';
                var gg = $(".ggpro" + i);
    ...
    <div class="azshowbox">
        <input id="inp_pid" value="<%=pro_id %>" style="display: none;" />
        <div class="aozhouboxshow">
                ...
                <div class="azboxshow2_right">
                    <div class="azboxshow2_right_1">
                        ...
                        <div class="azboxshow2_right_1_right">
                            ...
                            <div class="azboxshow2_right_1_right_2" id="div_shoucang">
                                <%  int num = new publicclass().GetTotalFavorite(pro_id, null);
                                %>
                                已有<%=num
                                %>人收藏
                            </div>
                            <div class="azboxshow2_right_1_right_3">
                                ...
                                <span class="abs2r1r3_2">返现</span> <span class="abs2r1r3_3">
                                    ￥ 10</span>--%>
                            </div>
                        </div>
                    </div>
            ...
            <script type="text/javascript">
                ...
                function change(abc) {
                    ...
                    for (var i = 1; i <= 10; i++) {
                        if ($("#t" + i).length > 0)
                            totproce = totproce + $("#t" + i).val() * $("#xzjg" + i).text();
                    }


                    var value = document.getElementById('t' + abc).value;
                    //                    var v1 = document.getElementById('t' + abc).value;
                    //                    var jg1 = document.getElementById('xzjg'+abc).innerHTML;
                    //                    var zj1 = v1 * jg1;

                    //                    var spzjg = spzjg+zj3 + zj2 + zj1;
                    if (value > 20) {
                        alert("您输入的数字超过限时数量。最多20！")
                        document.getElementById('t' + abc).value = 1;
                    } else {
                        document.getElementById('t' + abc).value = value;
                        document.getElementById('zjiage').innerHTML = totproce;
                    }
                }
            </script>
            <style>
        ...
        <div class="azheight25">
            <a href="aozhou.aspx?gj=<%=pub_gj %>">查看更多产品>></a>
        </div>
        <div class="azheight25">
        </div>
        <div class="azheight25">

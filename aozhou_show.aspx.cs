...
public partial class aozhou_show : System.Web.UI.Page
{
    ...
    public string chuxingrPrice = string.Empty, taocanPrice = string.Empty, pub_gj = string.Empty;
    ...
    public void showContent()
    {
        ...
        foreach (DataRow dr in dt.Rows)
        {
            ...
            pub_gj = Convert.ToString(dr["yw_country"]);
             ...
             foreach (DataRow dr in dt.Rows)
             {
                 ...
                 else if (Convert.ToString(dr["stype"]) == "2")
                 {
                     sbr2.Append(@"<tr class='ggpro" + i + @"'>
                            ...
                            <td>
                                <span class='ddt_fzjg'><span id='fxjg" + i + @"'>0</span></span>
                            </td>
                            <td>
                                <span class='ddt_xzjg'><span id='xzjg" + i + @"' name='xzjg"+id+@"'>" + dr["proprice"] + @"</span></span>
                            </td>

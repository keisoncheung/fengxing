...
public partial class chakangengduo : System.Web.UI.Page
{
    int pagemax = 24; //没页个数;
    string pagelist = "";
    string cp = "1";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!this.IsPostBack)
        {
            ...
            {
                if (Request["gj"] + "" == "0")
                    daohang = "<a href='index.aspx'>风行旅游网</a>><a href='chakangengduo.aspx?gj=" + Request["gj"] + "'>私家定制</a>";
                else
                    daohang = "<a href='index.aspx'>风行旅游网</a>><a href='chakangengduo.aspx?gj=" + Request["gj"] + "'>私家定制</a>";
            }
            getstype();
    ...
    public void getstype()
    {
        ...
        string sql = "select id,clsname from productType where parid=374;";
    ...
    {
        string where = " where languageId=1 and sfzyx=2 ";
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                //                                    <div class='text_3'>
                //                                        <span class='t3span1'>AUD " + dr["jiage"] + @"&nbsp;</span> <span class='t3span2'>AUD 650</span>
                ...
                Html.Append(@"<li>
                	<div class='henglistbox'>
                    	<div class='henglistbox_left'>
                        	<a href='dingzhishow.aspx?pro_id=" + dr["id"] + @"'  target='_blank' ><img src='pic/" + dr["pictureb"] + @"' width='227' height='168' /></a>
                        </div>
                        <div class='henglistbox_cent'>
                        	<div class='henglistbox_cent_1'><a href='dingzhishow.aspx?pro_id=" + dr["id"] + @"'  target='_blank'>" + dr["proname"] + @" (" + dr["proname2"] + @"）</a></div>
                            ...
                            已有1060人购买 | 5.0分      城市：" + getCity(dr["city"] + "") + @"       行程天数：" + dr["peoplesNums"] + @"
                            </div>
                        </div>
                        <div class='henglistbox_righ'>
                        	...
                        	<div class='headlistbox_righ_3'><a href='dingzhishow.aspx?pro_id=" + dr["id"] + @"'>立即购买</a></div>
                        </div>
                    </div>
                    </li>");

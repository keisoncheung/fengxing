...
public partial class dingzhishow : System.Web.UI.Page
{
        ...
        foreach (DataRow dr in dt.Rows)
        {
            if (!string.IsNullOrEmpty(Convert.ToString(dr["yw_country"])))
            {
                if (Convert.ToString(dr["yw_country"]) == "0")
                    title = " <a href='index.aspx'>风行旅游网</a>><a href='chakangengduo.aspx?pid=" + dr["parid"] + "'>私人定制</a>><span>" + Convert.ToString(dr["proname"]) + "</span>";

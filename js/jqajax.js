...
function mlogin()
{
    ...
    else
    {
        ...
        $.ajax({
                ...
                url:"jqajax.aspx",
                dataType:"html",
                data: "ntype=log&lname=" + $("#txtlname").val() + "&pwd=" + $("#txtpwd").val() + "&ntime=" + (new Date()).getTime(),
                ...
                success:function(msg)
                    {   
                         if(msg == "1") {
                            ...
                            window.location.href = "guodu.aspx";
                         }
                         else if(msg == "2")
                         {
...
function mreg()
{
    ...
    else if($("#txtpwd2").val() != $("#txtpwd").val())
    {
        ...
        $("#txtpwd").val("");
         ...
         if (checkemail($("#txtname").val()) == false) {
             $("#txtname").focus();
             return;

        }

         if (checkPwd($("#txtpwd").val()) == false) {
             $("#txtpwd").focus();
             return;
        ...
        $.ajax({
                ...
                url:"jqajax.aspx",
                dataType:"html",
                data:"ntype=reg&lname="+$("#txtname").val()+"&pwd="+$("#txtpwd").val()+"&ntime="+(new Date()).getTime(),
                beforeSend:function(XMLHttpRequest)
                    {
                    },
                success:function(msg)
...
function checkPwd(str) {
    var sReg = /^[\x21-\x7E]{6,20}$/;
    if (!sReg.test(str)) {
        alert("6-20字符，能用字母、数字或符号的组合");
        return false;
    }

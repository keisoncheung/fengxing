<%@ Page Language="C#" AutoEventWireup="true" CodeFile="am_jingdianshow.aspx.cs" Inherits="manager_am_jingdianshow" %>
       ...
       <%=str_addbt%>
        ...
        <tr><td align="left"><table border=0><tr><td>关键字搜索：</td><td>
            <asp:TextBox ID="tbxkw" runat="server" Width="300px"></asp:TextBox></td><td>
                <asp:Button ID="Button1" runat="server" Text="搜索" Width="44px" /></td><td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                <asp:Button ID="Button2" runat="server" Text="确定选择" Width="125px" Height="51px" /></td></tr></table></td></tr>
        ...
        <asp:GridView ID="grv1" runat="server" AutoGenerateColumns="False" CellPadding="4" OnPageIndexChanging="grv1_PageIndexChanging"
            ...
            <Columns>
                ...
                <asp:HyperLinkField HeaderText="编辑" Text="【查看】"  DataNavigateUrlFields="id" DataNavigateUrlFormatString="am_jingdianadd.aspx?id={0}&amp;ac=管理">

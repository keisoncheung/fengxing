<%@ Page Language="C#" AutoEventWireup="true" CodeFile="baoxianadd.aspx.cs" Inherits="manager_baoxianadd"
    ...
    <font face="宋体">
        ...
        <table border="0" cellspacing="1" cellpadding="1" style="width: 758px;" align="center">
            ...
            <tr>
                ...
                <td style="width: 365px; height: 25px" valign="top">
                    <font face="宋体">
                        <asp:DropDownList ID="ddcity" runat="server" Width="147px" OnSelectedIndexChanged="ddcity_SelectedIndexChanged">
            ...
            <tr style="">
                ...
                <td style="width: 365px; height: 25px" valign="top">
                    <asp:TextBox ID="jiage" runat="server" Width="147px">0</asp:TextBox>
                </td>
            </tr>
            <tr style="">
                <td style="width: 113px; height: 25px" align="center">
                ...
                <td style="width: 365px; height: 25px" valign="top">
                    <asp:TextBox ID="tbxjiage2" runat="server" Width="147px">0</asp:TextBox>
                </td>
            </tr>
            <tr style="display: none;">
                <td style="width: 113px; height: 25px" align="center">
                ...
                <td style="width: 365px; height: 25px" valign="top">
                    <asp:TextBox ID="tbxfanxian" runat="server" Width="147px">0</asp:TextBox>
                </td>
            </tr>
            <tr style="display: none;">
                <td style="width: 113px; height: 25px" align="center">

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="baoxianjihuaadd.aspx.cs" Inherits="manager_baoxianjihuaadd" %>
...
<HEAD>
	...
	<body leftMargin="0" topMargin="0">  
        ...
        <font face="宋体">
         <asp:DropDownList ID="drtype" runat="server" Width="137px" >
                        ...
                        <asp:DropDownList ID="sel_city" Visible="false" runat="server" Width="147px">
                            </asp:DropDownList>
        </font>
                     </td>
                </tr>
					...
					<TR>
						<TD align=center style="WIDTH: 294px; height: 21px;color:Black;">保险计划：</TD>

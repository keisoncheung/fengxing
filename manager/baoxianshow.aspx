<%@ Page Language="C#" AutoEventWireup="true" CodeFile="baoxianshow.aspx.cs" Inherits="manager_baoxianshow" %>
                ...
                <td style="width: 100%; height: 170px;">
                    <asp:GridView ID="grv1" runat="server" AutoGenerateColumns="False" CellPadding="4"
                        ...
                        <Columns>
                            ...
                            <asp:HyperLinkField HeaderText="编辑" Text="【查看】" DataNavigateUrlFields="id" DataNavigateUrlFormatString="baoxianadd.aspx?id={0}&amp;ac=管理">

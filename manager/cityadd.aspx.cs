...
using DLL;
public partial class manager_cityadd : System.Web.UI.Page
{
    ...
    {
        string str = null;
        string sql = "select Id,clsname1,clsname2,languageId from citytype where ID=" + id;
        try
        {
        ...
        if (drtype.SelectedValue == "-1")
        {
            ...
            return;
                ...
                if (Request["id"] != null)
                {
                    ...
                    sql = "update citytype set clsname1='" + txttitle.Value + "',clsname2='" + drtype.SelectedValue + "' where ID=" + Request["id"].ToString() + "";
                    ...
                    if (Igs(sql))
                    {
                        Response.Write("<script LANGUAGE=\"JavaScript\">alert(\"修改成功！\");location.href=\"./cityshow.aspx?lan=" + rbl.SelectedValue + "&ac=新闻管理咨询\";</script>");
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    sql = "insert into citytype(clsname1,LanguageId,clsname2) values('" + txttitle.Value + "','" + rbl.SelectedValue + "','" + drtype.SelectedValue + "')";

                    if (Igs(sql))
                    {
                        Response.Write("<script LANGUAGE=\"JavaScript\">alert(\"添加成功！\");location.href=\"./cityshow.aspx?lan=" + rbl.SelectedValue + "&ac=新闻管理咨询\";</script>");
                    }
                    else
                    {
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("cityshow.aspx");

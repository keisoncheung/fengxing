...
public partial class manager_dingzhihotelshow : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            str_addbt = "<a href='dingzhihoteladd.aspx?type=" + s_type + "' style='display:block; float:left; margin-right:20px; color:Red;'>添加资料</a>";
            showsj();
            //cstype();
            intro();
        }
    ...
    public void showsj()
    {
        string where = " where  sortid=0 and sfzyx=2";
    ...
    protected void ddprotypelist_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddprotypelist.SelectedItem.Text.Contains("---"))
            Response.Redirect("dingzhihotelshow.aspx?type=" + s_type + "&id=" + ddprotypelist.SelectedValue);
        else
            Response.Redirect("dingzhihotelshow.aspx?type=" + s_type);
    }
}

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="hoteladd.aspx.cs" Inherits="manager_hoteladd"
    ...
    <font face="宋体">
        ...
        <table border="0" cellspacing="1" cellpadding="1" style="width: 758px;" align="center">
            ...
            <tr>
             ...
             <tr>
                <td style="width: 113px; height: 25px" align="center">
                    <font face="宋体">促销时间</font>
                </td>
                <td style="width: 365px; height: 25px" valign="top">
                    <font face="宋体">
                        <asp:TextBox ID="tbxcuxiao" runat="server" Width="439px" ></asp:TextBox>(促销时间)
                    </font>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="width: 365px; height: 25px" valign="top">
                    <font face="宋体">
                        <asp:DropDownList ID="ddcity" runat="server" Width="147px" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">

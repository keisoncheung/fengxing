    ...
    public void csh()
    {
        ...
        try
        {
            ...
            foreach (DataRow or in dt.Select())
            {
                ...
                string dlid = Convert.ToString(OleDbHelper.ExecuteScalar(OleDbHelper.Conn, "select ParId from productType where id=" + or["ParId"], null));
                ...
                tbxcuxiao.Text = Convert.ToString(or["cuxiao"]);
    ...
    protected void Submit1_ServerClick(object sender, EventArgs e)
    {
        ...
        if (drtype.SelectedValue != "0")
        {
            if (bpic.Length > 1)
            {
                ...
                {
                    sql = "insert into product(ProName,PictureB,PictureS,CreateDate,parid,languageId,grade,canshu,txtsortid,peoplesNums,address,city,xingji,jiage,jiage2,ProName2,gj_lan_val,gj_lan_text,ProName3,yw_country,jingdian,fanxian,sfzyx,cuxiao " + str_insert1 + ") values('" + name.Text + "','" + bpic + "','" + spic + "','" + DateTime.Now.ToString() + "','" + drtype2.SelectedValue + "','" + rbl.SelectedValue + "','" + sfshow + "','" + canshu.Text + "','" + txtsort.Text.Trim() + "','" + tbxpeople.Text + "','" + tbxaddr.Text + "','" + sel_city.SelectedValue + "','" + sel_xj.Value + "','" + jiage.Text + "','"+tbxjiage2.Text+"','" + tbxname2.Text + "','" + ddl_lan.SelectedValue + "','" + ddl_lan.SelectedItem.Text + "','" + tbxname3.Text + "','" + ddcity.SelectedValue + "','" + ddl_jingdian.SelectedValue + "','" + tbxfanxian.Text + "','"+sfzyx+"','"+tbxcuxiao.Text+"' " + str_insert2 + ")";
            ...
            else
            {
                if (Request["id"] != null)
                {
                    sql = "update product set ProName='" + name.Text + "',grade='" + sfshow + "',parid='" + drtype2.SelectedValue + "',languageId='" + rbl.SelectedValue + "',CreateDate='" + DateTime.Now.ToString() + "',canshu='" + canshu.Text + "',txtsortid='" + txtsort.Text.Trim() + "',peoplesNums='" + tbxpeople.Text + "',address='" + tbxaddr.Text + "',gj_lan_val='" + ddl_lan.SelectedValue + "',gj_lan_text='" + ddl_lan.SelectedItem.Text + "',city='" + sel_city.SelectedValue + "',xingji='" + sel_xj.Value + "',jiage='" + jiage.Text + "',jiage2='" + tbxjiage2.Text + "',jingdian='" + ddl_jingdian.SelectedValue + "',fanxian='" + tbxfanxian.Text + "',ProName2='" + tbxname2.Text + "',ProName3='" + tbxname3.Text + "',yw_country='" + ddcity.SelectedValue + "',sfzyx='" + sfzyx + "',cuxiao='" + tbxcuxiao.Text + "'  " + str_Update + "  where id=" + Request["id"] + "";
                    if (Igs(sql))
                    {
                        Response.Write("<script LANGUAGE=\"JavaScript\">alert(\"资料修改成功！\");location.href=\"./hotelshow.aspx?lan=" + rbl.SelectedValue + "&type=" + drtype.SelectedValue + "\";</script>");
                    }
                ...
                else
                {
                    ...
                    sql = "insert into product(ProName,PictureB,PictureS,CreateDate,parid,languageId,grade,canshu,txtsortid,peoplesNums,address,city,xingji,jiage,jiage2,ProName2,gj_lan_val,gj_lan_text,ProName3,yw_country,jingdian,fanxian,sfzyx,cuxiao " + str_insert1 + ") values('" + name.Text + "','nopic.gif','nopic.gif','" + DateTime.Now.ToString() + "','" + drtype2.SelectedValue + "','" + rbl.SelectedValue + "','" + sfshow + "','" + canshu.Text + "','" + txtsort.Text.Trim() + "','" + tbxpeople.Text + "','" + tbxaddr.Text + "','" + sel_city.SelectedValue + "','" + sel_xj.Value + "','" + jiage.Text + "','"+tbxjiage2.Text+"','" + tbxname2.Text + "','" + ddl_lan.SelectedValue + "','" + ddl_lan.SelectedItem.Text + "','" + tbxname3.Text + "','" + ddcity.SelectedValue + "','" + ddl_jingdian.SelectedValue + "','" + tbxfanxian.Text + "','"+sfzyx+"','"+tbxcuxiao.Text+"' " + str_insert2 + ")";

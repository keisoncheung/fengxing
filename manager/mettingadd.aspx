<%@ Page Language="C#" AutoEventWireup="true" CodeFile="mettingadd.aspx.cs" Inherits="manager_mettingadd" ValidateRequest="false" %>
    ...
    <form id="form1" method="post" runat="server">
       ...
       <asp:RadioButtonList ID="rbl" runat="server" RepeatDirection="Horizontal" 
        ...
        <font face="宋体">
                    ...
                    <td style="width: 365px; height: 25px" valign="top">
        <font face="宋体">
            <asp:TextBox ID="tbxpeople" runat="server" Width="65px" Text="0"></asp:TextBox>(只能填数字)
        ...
        <font face="宋体">
                    ...
                    <td style="width: 365px; height: 25px" valign="top">
        <font face="宋体">
            <asp:TextBox ID="tbxaddr" runat="server" Width="279px"></asp:TextBox>

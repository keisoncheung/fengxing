...
public partial class manager_news : System.Web.UI.Page
{
    ...
    {
        string str = null;
        string sql = "select Id,Title,Content,ParId,languageId,canshu,tjzhishu from News where ID=" + id;
        try
        {
            ...
            foreach (DataRow or in dt.Select())
            {
                ...
                ddlxingji.SelectedValue = Convert.ToString(or["tjzhishu"]);
            }
        }
        catch (Exception rr)
        {
    ...
    protected void Submit1_ServerClick(object sender, EventArgs e)
    {
        ...
        if (ddl1.SelectedValue != "0")
        {
            if (bpic.Length > 1)
            {
                ...
                if (Request["id"] != null)
                {
                    sql = "update News set Title='" + txttitle.Value + "',Content='" + ss + "', ParId ='" + ddl1.SelectedValue + "',LanguageId='" + rbl.SelectedValue + "',picture='" + bpic + "',linkpic='" + spic + "',canshu='" + canshu.Text + "',tjzhishu='"+ddlxingji.SelectedValue+"' where ID=" + Request["id"].ToString() + "";
                ...
                {
                    sql = "insert into News(Title,Content,CreateDate,ParId,IsShow,LanguageId,picture,linkpic,canshu,tjzhishu) values('" + txttitle.Value + "','" + ss + "','" + DateTime.Now.ToString() + "','" + ddl1.SelectedValue + "',1,'" + rbl.SelectedValue + "','" + bpic + "','" + spic + "','" + canshu.Text + "','" + ddlxingji.SelectedValue + "')";
            ...
            else
            {
                if (Request["id"] != null)
                {
                    sql = "update News set Title='" + txttitle.Value + "',Content='" + ss + "', ParId ='" + ddl1.SelectedValue + "',LanguageId='" + rbl.SelectedValue + "',canshu='" + canshu.Text + "',tjzhishu='" + ddlxingji.SelectedValue + "' where ID=" + Request["id"].ToString() + "";
                ...
                {
                    sql = "insert into News(Title,Content,CreateDate,ParId,IsShow,LanguageId,canshu,tjzhishu) values('" + txttitle.Value + "','" + ss + "','" + DateTime.Now.ToString() + "','" + ddl1.SelectedValue + "',1," + rbl.SelectedValue + ",'" + canshu.Text + "','"+ddlxingji.SelectedValue+"')";

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="procarinfolist.aspx.cs" Inherits="manager_procarinfolist" %>
...
<!--#include file="daohang.aspx" -->
    ...
    <fieldset  style="width:100%; font-size:12px;">
       ...
       <%=str_addbt%>
        ...
        <table id="tabcont" border=0 cellSpacing="1" cellPadding="1" style="width:100%" align=center runat=server>
        ...
        <asp:GridView ID="grv1" runat="server" AutoGenerateColumns="False" CellPadding="4" OnPageIndexChanging="grv1_PageIndexChanging"
            ...
            <Columns>
                ...
                <asp:HyperLinkField HeaderText="编辑" Text="【查看】"  DataNavigateUrlFields="id" DataNavigateUrlFormatString="procarinfoshow.aspx?id={0}&amp;ac=管理">

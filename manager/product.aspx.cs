        ...
        if (drtype.SelectedValue != "0")
        {
            if (bpic.Length > 1)
            {
                ...
                if (Request["id"] != null)
                {
                    ...
                    if (Igs(sql))
                    {
                        Response.Write("<script LANGUAGE=\"JavaScript\">alert(\"资料修改成功！\");location.href=\"./proshow.aspx?lan=" + rbl.SelectedValue + "&type=" + drtype.SelectedValue + "\";</script>");
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    if (Igs(sql))
                    {
                        Response.Write("<script LANGUAGE=\"JavaScript\">alert(\"资料添加成功！\");location.href=\"./proshow.aspx?lan=" + rbl.SelectedValue + "&type=" + drtype.SelectedValue + "\";</script>");
                    }
                    else
                    {
                        Response.Write("<script LANGUAGE=\"JavaScript\">alert(\"资料修改失败！\");</script>");

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="qianzhengadd.aspx.cs" Inherits="manager_qianzhengadd"  ValidateRequest="false"  %>
...
<body>
    ...
    <font face="宋体">
        ...
        <table border="0" cellspacing="1" cellpadding="1" style="width: 758px;" align="center">
            ...
            <tr style=" display:none;">
                <td style="width: 113px; height: 25px" align="center">
                    <font face="宋体">受理时间</font>
                </td>
                <td style="width: 365px; height: 25px" valign="top">
                    <font face="宋体">
                        <asp:TextBox ID="txtsort" runat="server" Width="434px" Text="0"></asp:TextBox>
                    </font>
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 365px; height: 25px" valign="top">
                    <font face="宋体">
                       <asp:TextBox ID="tbx_shoulishijian" runat="server" Width="434px" Text=""></asp:TextBox>
                    </font>
                </td>
            </tr>
            <tr>
                <td align="center" class="style1">
                    <font face="宋体">有效时间</font>
                </td>
                <td valign="top" class="style2">
                    <font face="宋体">
            ...
            <tr>
                <td style="width: 113px; height: 25px" align="center">
                    <font face="宋体">游玩城市</font>
                </td>
                <td style="width: 365px; height: 25px" valign="top">
                    <font face="宋体">
                        <asp:DropDownList ID="ddcity" runat="server" Width="147px" 
                        onselectedindexchanged="ddcity_SelectedIndexChanged" >
                            ...
                            <asp:ListItem Value="3">中国</asp:ListItem>
                        </asp:DropDownList>
                        <asp:DropDownList ID="sel_city" runat="server" Width="147px" Visible="false" >
                        </asp:DropDownList>
                    </font>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="height: 21px; width: 551px;">
                    <asp:DropDownList ID="ddl_lan" runat="server" Width="148px">
                        ...
                        <asp:ListItem Value="1">乐享1~7天</asp:ListItem>
                        <asp:ListItem Value="2">乐享8~10天</asp:ListItem>
                        <asp:ListItem Value="3">乐享11~14天</asp:ListItem>
                    </asp:DropDownList>
                </td>
            </tr>
            <tr style=" display:none;">
            ...
            </tr><tr><td></td><td><asp:Label ID="Label1" runat="server" Text="121212"></asp:Label><br />
            </td></tr>
            <tr>
                <td bgcolor="#507CD1" colspan="3">
                    <font face="宋体" color="#ffffff">::签证信息::::::::::::::::::::::::::::::::::::::::::::::::::::::</font>
                </td>
            </tr>
            <tr>
                <td style="height: 305px" colspan="3">
                    <DNTB:WebEditor ID="txt_xiangqing" Skin="skin/xp/" systemFolder="system_dntb/" runat="server"
            ...
            <tr>
                <td bgcolor="#507CD1" colspan="3">
                    <font face="宋体" color="#ffffff">::所需资料::::::::::::::::::::::::::::::::::::::::::::::::::::::</font>
                </td>
            </tr>
            <tr>
                <td style="height: 305px" colspan="3">
                    <DNTB:WebEditor ID="txt_ydxz" Skin="skin/xp/" systemFolder="system_dntb/" runat="server"
                        AdjustSize="50" UploadFolder="../upfile/images/" Width="100%" LeftAreaAlign="center"
                        Height="350px"></DNTB:WebEditor>
                    &nbsp;
                </td>
            ...
            <tr>
                <td bgcolor="#507CD1" colspan="3">
                    <font face="宋体" color="#ffffff">::办理流程::::::::::::::::::::::::::::::::::::::::::::::::::::::</font>
                </td>
            </tr>
            <tr>
                <td style="height: 305px" colspan="3">
            ...
            <tr>
                <td bgcolor="#507CD1" colspan="3">
                    <font face="宋体" color="#ffffff">::注意事项::::::::::::::::::::::::::::::::::::::::::::::::::::::</font>
                </td>
            </tr>
            <tr>
                <td style="height: 305px" colspan="3">
            ...
            <tr>
                <td bgcolor="#507CD1" colspan="3">
                    <font face="宋体" color="#ffffff">::温馨提示::::::::::::::::::::::::::::::::::::::::::::::::::::::</font>
                </td>
            </tr>
            <tr>
                <td style="height: 305px" colspan="3">
             ...
             <tr>
                <td bgcolor="#507CD1" colspan="3">
                    <font face="宋体" color="#ffffff">::邮寄地址::::::::::::::::::::::::::::::::::::::::::::::::::::::</font>
                </td>
            </tr>
            <tr>
                <td style="height: 305px" colspan="3">
                    <DNTB:WebEditor ID="txt_youjidizhi" Skin="skin/xp/" systemFolder="system_dntb/" runat="server"
                        AdjustSize="50" UploadFolder="../upfile/images/" Width="100%" LeftAreaAlign="center"
                        Height="350px"></DNTB:WebEditor>
                    &nbsp;
                </td>
             ...
             <tr>
                <td bgcolor="#507CD1" colspan="3">
                    <font face="宋体" color="#ffffff">::购买保险::::::::::::::::::::::::::::::::::::::::::::::::::::::</font>
                </td>
            </tr>
            <tr>
                <td style="height: 305px" colspan="3">
                    <DNTB:WebEditor ID="txt_goumaibaoxian" Skin="skin/xp/" systemFolder="system_dntb/" runat="server"
                        AdjustSize="50" UploadFolder="../upfile/images/" Width="100%" LeftAreaAlign="center"
                        Height="350px"></DNTB:WebEditor>
                    &nbsp;
                </td>

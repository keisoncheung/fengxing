...
public partial class manager_qianzhengadd : System.Web.UI.Page
{
    ...
    public void csh()
    {
        ...
        try
        {
            ...
            foreach (DataRow or in dt.Select())
            {
                ...
                tbxname3.Text = Convert.ToString(or["jiage"]);
                ...
                txt_ydxz.Text = Convert.ToString(or["ydxz"]);
                txt_feiyong.Text = Convert.ToString(or["feiyong"]);
                txt_jiaotong.Text = Convert.ToString(or["jiaotong"]);
                txt_gonglue.Text = Convert.ToString(or["gonglue"]);
                txt_youjidizhi.Text = Convert.ToString(or["youjidizhi"]);
                txt_goumaibaoxian.Text = Convert.ToString(or["goumaibaoxian"]);
        ...
        if (ddcity.SelectedValue != "-1")
        {
            if (bpic.Length > 1)
            {
                ...
                if (Request["id"] != null)
                {
                    sql = "update product set ProName='" + name.Text + "', PictureB='" +
                        ...
                        txt_xiangqing.Text.Replace("'", "''") + "',grade='" + sfshow + "',parid='" + drtype2.SelectedValue + "',languageId='" + rbl.SelectedValue + "',CreateDate='" + DateTime.Now.ToString() + "',canshu='" + canshu.Text + "',txtsortid='" + txtsort.Text.Trim() + "',peoplesNums='" + tbxpeople.Text + "',address='" + tbxaddr.Text + "',gj_lan_val='" + ddl_lan.SelectedValue + "',ydxz='" + txt_ydxz.Text.Replace("'", "''") + "',feiyong='" + txt_feiyong.Text.Replace("'", "''") + "',jiaotong='" + txt_jiaotong.Text.Replace("'", "''") + "',gonglue='" + txt_gonglue.Text.Replace("'", "''") + "',gj_lan_text='" + ddl_lan.SelectedItem.Text + "',city='" + sel_city.SelectedValue + "',xingji='" + sel_xj.Value + "',jiage='" + jiage.Text + "',jingdian='" + ddl_jingdian.SelectedValue + "',fanxian='" + tbxfanxian.Text + "',ProName2='" + tbxname2.Text + "',jiage='" + tbxname3.Text + "',yw_country='" + ddcity.SelectedValue + "',sfzyx='4',shoulishijian='" + tbx_shoulishijian.Text + "',youjidizhi='" + txt_youjidizhi.Text.Replace("'", "''") + "',goumaibaoxian='" + txt_goumaibaoxian.Text.Replace("'", "''") + "' " + str_Update + " where id=" + Request["id"] + "";
                    if (Igs(sql))
                    {
                ...
                {
                    sql = "insert into product(ProName,PictureB,PictureS,Content,CreateDate,parid,languageId,grade,canshu,txtsortid,peoplesNums,address,city,xingji,jiage,ydxz,feiyong,jiaotong,gonglue,ProName2,gj_lan_val,gj_lan_text,jiage,yw_country,jingdian,fanxian,sfzyx,shoulishijian,youjidizhi,goumaibaoxian " + str_insert1 + ") values('" + name.Text + "','" + bpic + "','" + spic + "','" + txt_xiangqing.Text.Replace("'", "''") + "','" + DateTime.Now.ToString() + "','" + drtype2.SelectedValue + "','" + rbl.SelectedValue + "','" + sfshow + "','" + canshu.Text + "','" + txtsort.Text.Trim() + "','" + tbxpeople.Text + "','" + tbxaddr.Text + "','" + sel_city.SelectedValue + "','" + sel_xj.Value + "','" + jiage.Text + "','" + txt_ydxz.Text.Replace("'", "''") + "','" + txt_feiyong.Text.Replace("'", "''") + "','" + txt_jiaotong.Text.Replace("'", "''") + "','" + txt_gonglue.Text.Replace("'", "''") + "','" + tbxname2.Text + "','" + ddl_lan.SelectedValue + "','" + ddl_lan.SelectedItem.Text + "','" + tbxname3.Text + "','" + ddcity.SelectedValue + "','" + ddl_jingdian.SelectedValue + "','" + tbxfanxian.Text + "','4','" + tbx_shoulishijian.Text + "','" + txt_youjidizhi.Text.Replace("'", "''") + "','" + txt_goumaibaoxian.Text.Replace("'", "''") + "' " + str_insert2 + ")";
            ...
            else
            {
                ...
                else
                {
                    ...
                    sql = "insert into product(ProName,PictureB,PictureS,Content,CreateDate,parid,languageId,grade,canshu,txtsortid,peoplesNums,address,city,xingji,jiage,ydxz,feiyong,jiaotong,gonglue,ProName2,gj_lan_val,gj_lan_text,jiage,yw_country,jingdian,fanxian,sfzyx,shoulishijian,youjidizhi,goumaibaoxian  " + str_insert1 + ") values('" + name.Text + "','nopic.gif','nopic.gif','" + txt_xiangqing.Text.Replace("'", "''") + "','" + DateTime.Now.ToString() + "','" + drtype2.SelectedValue + "','" + rbl.SelectedValue + "','" + sfshow + "','" + canshu.Text + "','" + txtsort.Text.Trim() + "','" + tbxpeople.Text + "','" + tbxaddr.Text + "','" + sel_city.SelectedValue + "','" + sel_xj.Value + "','" + jiage.Text + "','" + txt_ydxz.Text.Replace("'", "''") + "','" + txt_feiyong.Text.Replace("'", "''") + "','" + txt_jiaotong.Text.Replace("'", "''") + "','" + txt_gonglue.Text.Replace("'", "''") + "','" + tbxname2.Text + "','" + ddl_lan.SelectedValue + "','" + ddl_lan.SelectedItem.Text + "','" + tbxname3.Text + "','" + ddcity.SelectedValue + "','" + ddl_jingdian.SelectedValue + "','" + tbxfanxian.Text + "','4','" + tbx_shoulishijian.Text + "','" + txt_youjidizhi.Text.Replace("'", "''") + "','" + txt_goumaibaoxian.Text.Replace("'", "''") + "' " + str_insert2 + ")";

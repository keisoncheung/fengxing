...
public partial class manager_shebeipicturelist : System.Web.UI.Page
{
    ...
    public void showsj()
    {
        ...
        string sql = "select * from MainPic where parid=4 order by [id] desc";
        string sql1 = "select count([id]) from MainPic  where parid=4 ";

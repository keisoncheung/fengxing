...
public partial class manager_tuanduilvyouadd : System.Web.UI.Page
{
    ...
    {
        string str = null;
        string sql = "select id,ProName,ProName2,ProName3,PictureB,PictureS,Content,parid,languageId,grade,canshu,txtsortid,prokeyword,Promode,ProSize,peoplesnums,address,city,xingji,jiage,jiage2,gj_lan_val,gj_lan_text,yw_country,jingdian,fanxian ,ydxz,feiyong,jiaotong,gonglue,sfzyx,f_city,f_country  from product where id=" + id;
        try
        {
            DataTable dt = new DataTable();
            ...
            foreach (DataRow or in dt.Select())
            {
                ...
                ddlcfcity.SelectedValue = Convert.ToString(or["f_country"]);
                DropDownList1_SelectedIndexChanged(null, null);
                ddlcfcity2.SelectedValue = Convert.ToString(or["f_city"]);
    ...
    {
        string str_max =string.Empty;

        if (ddcity.SelectedValue == "-1")
        {
            Response.Write("<script LANGUAGE=\"JavaScript\">alert(\"请选择结束城市国家！\");</script>");
            return;
        }
        if (ddlcfcity.SelectedValue == "-1")
        {
            Response.Write("<script LANGUAGE=\"JavaScript\">alert(\"请选择出发城市国家！\");</script>");
            return;
        }
        ...
        if (bpic.Length > 1)
        {
            ...
            {
                sql = "insert into product(ProName,PictureB,PictureS,CreateDate,parid,languageId,grade,canshu,txtsortid,peoplesNums,address,city,xingji,jiage,jiage2,ProName2,gj_lan_val,gj_lan_text,ProName3,yw_country,jingdian,fanxian,sfzyx,f_city,f_country " + str_insert1 + ") values('" + name.Text + "','" + bpic + "','" + spic + "','" + DateTime.Now.ToString() + "','" + drtype2.SelectedValue + "','" + rbl.SelectedValue + "','" + sfshow + "','" + canshu.Text + "','" + txtsort.Text.Trim() + "','" + tbxpeople.Text + "','" + tbxaddr.Text + "','" + sel_city.SelectedValue + "','" + sel_xj.Value + "','" + jiage.Text + "','" + tbxjiage2.Text + "','" + tbxname2.Text + "','" + ddl_lan.SelectedValue + "','" + ddl_lan.SelectedItem.Text + "','" + tbxname3.Text + "','" + ddcity.SelectedValue + "','" + ddl_jingdian.SelectedValue + "','" + tbxfanxian.Text + "',3,'" + ddlcfcity2.SelectedValue + "','" + ddlcfcity.SelectedValue + "' " + str_insert2 + ")";

                if (Igs(sql))
                {
                    insertXC();
                    Response.Write("<script LANGUAGE=\"JavaScript\">alert(\"资料添加成功！\");location.href=\"./tuanduilvyoushow.aspx\";</script>");
                }
                else
                {
                    Response.Write("<script LANGUAGE=\"JavaScript\">alert(\"资料修改失败！\");</script>");
        ...
        else
        {
            ...
            else
            {
                ...
                sql = "insert into product(ProName,PictureB,PictureS,CreateDate,parid,languageId,grade,canshu,txtsortid,peoplesNums,address,city,xingji,jiage,jiage2,ProName2,gj_lan_val,gj_lan_text,ProName3,yw_country,jingdian,fanxian,sfzyx,f_city,f_country  " + str_insert1 + ") values('" + name.Text + "','nopic.gif','nopic.gif','" + DateTime.Now.ToString() + "','" + drtype2.SelectedValue + "','" + rbl.SelectedValue + "','" + sfshow + "','" + canshu.Text + "','" + txtsort.Text.Trim() + "','" + tbxpeople.Text + "','" + tbxaddr.Text + "','" + sel_city.SelectedValue + "','" + sel_xj.Value + "','" + jiage.Text + "','" + tbxjiage2.Text + "','" + tbxname2.Text + "','" + ddl_lan.SelectedValue + "','" + ddl_lan.SelectedItem.Text + "','" + tbxname3.Text + "','" + ddcity.SelectedValue + "','" + ddl_jingdian.SelectedValue + "','" + tbxfanxian.Text + "',3,'" + ddlcfcity2.SelectedValue + "','" + ddlcfcity.SelectedValue + "'  " + str_insert2 + ")";
    ...
    public void insertXC()
    {
        ...
        {
            sql = "insert into pro_xingcheng(clsname,languageId,parid,SortId,proid,sfzyx)values('" + name.Text + "','1','0','0'," + dr["id"] + ","+dr["sfzyx"]+")";
            OleDbHelper.ExecuteNonQuery(OleDbHelper.Conn, sql, null);
        }
    ...
    {
        string sql = "select id,clsname1 from citytype where clsname2='" + ddlcfcity.SelectedValue + "'  and   (sortid is null)  order by id";
        ddlcfcity2.DataSource = OleDbHelper.ExecuteDataSet(OleDbHelper.Conn, sql, null);
        ddlcfcity2.DataTextField = "ClsName1";
        ddlcfcity2.DataValueField = "id";
        ddlcfcity2.DataBind();
        ddlcfcity2.Items.Insert(0, "--请选择--");
        ddlcfcity2.Items[0].Value = "0";
    }
    ...
    {
        tbxaddr.Text = Calendar1.SelectedDate.ToString("yyyy-MM-dd");
    }
}

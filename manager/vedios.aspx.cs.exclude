...
public partial class training_manager_vedios : System.Web.UI.Page
{
    ...
    {
        string str = null;
        string sql = "select id,title,linkurl,languageId from news where id=" + id;
        try
        {
    ...
    protected void Submit1_ServerClick(object sender, EventArgs e)
    {
        ...
        if (bpic.Length > 1)
        {
            ...
            {
                sql = "insert into news(title,Picture,linkpic,CreateDate,languageId,linkurl,parid) values('" + name.Text + "','" + bpic + "','" + spic + "','" + DateTime.Now.ToString() + "','" + rbl.SelectedValue + "','" + web.Text + "',81)";
        ...
        else
        {
            if (Request["id"] != null)
            {
                sql = "update news set title='" + name.Text + "',languageId='" + rbl.SelectedValue + "',linkurl='" + web.Text + "',CreateDate='" + DateTime.Now.ToString() + "' where id=" + Request["id"] + "";
                if (Igs(sql))
                {
                    Response.Write("<script LANGUAGE=\"JavaScript\">alert(\"资料修改成功！\");location.href=\"./vediosshow.aspx?lan=" + rbl.SelectedValue + "\";</script>");
                }
            ...
            {
                sql = "insert into news(title,Picture,linkpic,CreateDate,languageId,linkurl,parid) values('" + name.Text + "','nopic.gif ','nopic.gif ','" + DateTime.Now.ToString() + "','" + rbl.SelectedValue + "','" + web.Text + "',81)";

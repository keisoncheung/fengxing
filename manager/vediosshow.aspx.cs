...
public partial class training_manager_vediosshow : System.Web.UI.Page
{
    ...
    public void showsj()
    {
        ...
        foreach (DataRowView ott in dt.DefaultView)
        {
            ...
            //ott["sprotype"] = "【" + Convert.ToString(ott["title"]) + "】";
            //ott["spic1"] = "<img src='../pic/" + ott["linkpic"] + "' width=80px;height=70px;>";
        }

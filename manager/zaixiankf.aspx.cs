...
public partial class manager_zaixiankf : System.Web.UI.Page
{
    ...
    protected void Submit1_ServerClick(object sender, EventArgs e)
    {
        ...
        if (bpic.Length > 1)
        {
            ...
            if (Request["id"] != null)
            {
                ...
                if (Igs(sql))
                {
                    Response.Write("<script LANGUAGE=\"JavaScript\">alert(\"资料修改成功！\");location.href=\"./zaixiankfshow.aspx?lan=" + rbl.SelectedValue + "\";</script>");
                }
                else
                {
            ...
            {
                sql = "insert into Links(title,Picture,linkpic,CreateDate,languageId,linkurl,parid) values('" + name.Text + "','" + bpic + "','" + spic + "','" + DateTime.Now.ToString() + "','" + rbl.SelectedValue + "','" + web.Text + "',16)";

                if (Igs(sql))
                {
                    Response.Write("<script LANGUAGE=\"JavaScript\">alert(\"资料添加成功！\");location.href=\"./zaixiankfshow.aspx?lan=" + rbl.SelectedValue + "\";</script>");
                }
                else
                {
                    Response.Write("<script LANGUAGE=\"JavaScript\">alert(\"资料修改失败！\");</script>");
        ...
        else
        {
            ...
            {
                sql = "insert into Links(title,Picture,linkpic,CreateDate,languageId,linkurl,parid) values('" + name.Text + "','nopic.gif ','nopic.gif ','" + DateTime.Now.ToString() + "','" + rbl.SelectedValue + "','" + web.Text + "',16)";

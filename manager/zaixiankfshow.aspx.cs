...
public partial class manager_zaixiankfshow : System.Web.UI.Page
{
    ...
    public void showsj()
    {
        ...
        foreach (DataRowView ott in dt.DefaultView)
        {
            ...
            ott["sprotype"] = "【" + Convert.ToString(ott["title"]) + "】<br>【" + Convert.ToString(ott["linkurl"]) + "】";

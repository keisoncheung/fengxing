...
public partial class manager_ziyouxingshow : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            str_addbt = "<a href='ziyouxingadd.aspx?type=" + s_type + "' style='display:block; float:left; margin-right:20px; color:Red;'>添加资料</a>";
            showsj();
            //cstype();
            intro();
        }
    ...
    public void showsj()
    {
        string where = " where  sortid=0 and sfzyx=1 ";
    ...
    protected void ddprotypelist_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddprotypelist.SelectedItem.Text.Contains("---"))
            Response.Redirect("ziyouxingshow.aspx?type=" + s_type + "&id=" + ddprotypelist.SelectedValue);
        else
            Response.Redirect("ziyouxingshow.aspx?type=" + s_type);
    }
}

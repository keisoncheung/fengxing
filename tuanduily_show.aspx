<%@ Page Title="" Language="C#" MasterPageFile="~/mar1.master" AutoEventWireup="true"
    CodeFile="tuanduily_show.aspx.cs" Inherits="tuanduily_show" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript" src="js/show/wq.component.js"></script>
    <script type="text/javascript" src="js/show/jquery.lazyLoad.js"></script>
    <script src="js/CarHelper.js" type="text/javascript"></script>
            ...
            <div class="azboxshow3">
                ...
                <div class="abbox_ddt_3">
                    ...
                    <div class="abox_ddt_3gwc">
                        <a href="javascript:goCar(<%=pro_id %>);">加入购物车</a></div>
                </div>
            </div>
            <div class="azheight25">
            </div>
                ...
                <div class="azboxshow5_1">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td align="right">
                                <span class="liaojie"><a href="faxian.html">了解返现规则</a></span>
                            </td>
                        </tr>
                    </table>
                </div>
...
foreach (System.Data.DataRow dr in dt.Rows)
{
                    ...
                    <li>
                        ...
                        <div class="tjcp_tit">
                            <a href="aozhou_show.aspx?pro_id=<%=dr["id"] %>"><%=dr["ProName"]%>（<%=dr["ProName2"]%>）</a>
                        </div>
                        <div class="tjcp_pri">
        ...
        <div class="azheight25">
            <a href="tuanduily.aspx?gj=-1">查看更多产品>></a>
        </div>
        <div class="azheight25">
        </div>
        <div class="azheight25">
